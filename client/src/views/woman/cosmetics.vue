    ...
    await axios
      ...
      .then((card) => {
        console.log(card);
          ...
          console.log(i)
          return n.category === 'Декоративная Косметика' && n.gender === 'woman' ;
        });
      });
  }
}
...
.complete{
  .top{
    height: 400px;
    width: 100%;
    background: url('https://www.amorettiprofumi.com/pub/media/catalog/category/makeup.jpg') no-repeat center center / cover;
  }
}
</style>